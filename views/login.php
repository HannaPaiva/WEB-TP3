...
<body>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="formAuthentication" class="mb-3" action="../php/processlogin.php" method="POST">
              ...
              <div class="mb-3">
                <button class="btn btn-primary d-grid w-100" type="button" onclick="performLogin()">Entrar</button>
              </div>
            </form>
            <p class="text-center">
            ...
            <p class="text-center">
              <span>Não quer fazer login?</span>
              <a href="./mostrarficheirosVisitante.php">
                <span>Veja como visitante</span>
              </a>
            </p>
          </div>
        </div>
  ...
  function performLogin() {
    ...
    if (document.getElementById('remember-me').checked) {
      document.cookie = 'email=' + email + '; expires=Thu, 01 Jan 2025 00:00:00 UTC; path=/';
      document.cookie = 'password=' + password + '; expires=Thu, 01 Jan 2025 00:00:00 UTC; path=/';
    } else {
      document.cookie = 'email=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/'; // Remover cookie
      document.cookie = 'password=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/';
    }

    // Aqui você pode fazer a chamada AJAX para o seu arquivo PHP
    $.ajax({
      type: 'POST',
      url: '../php/processlogin.php',
      data: $('#formAuthentication').serialize(), // Serializa os dados do formulário
  ...
  document.addEventListener('DOMContentLoaded', function () {
    // Preenche os campos do formulário com os valores dos cookies ao carregar a página
    ...
    // Adiciona um ouvinte de eventos para o botão de login se existir
